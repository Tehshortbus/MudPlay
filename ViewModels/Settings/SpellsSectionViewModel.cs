    ...
    public override IReadOnlyList<StubGroup> Groups { get; } = new[]
    {
        new StubGroup("Spell type priority (between-round casting order)", new[]
        {
            ...
            new StubField("Minor self heal",  StubFieldKind.Numeric,
                          ...
                          Min: 1, Max: 7),
            new StubField("Major self heal",  StubFieldKind.Numeric,
            ...
            new StubField("Debuffing", StubFieldKind.Numeric,
                          "Priority slot for between-round debuffs.",
                          Min: 1, Max: 7),
        }),
        new StubGroup("Healing / regeneration", new[]
        {
            new StubField("Minor heal",     StubFieldKind.Combo,   "Cheap self-heal — fires when Health → Minor heal (combat) threshold trips."),
            new StubField("Major heal",     StubFieldKind.Combo,   "Expensive self-heal — fires when Health → Major heal (combat) threshold trips."),
